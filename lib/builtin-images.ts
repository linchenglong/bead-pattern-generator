...
const ANIME: BuiltInImage[] = [
  ...
  unsplash('1558618666-fcd25c85f82e', '日本动漫街'),
...
const SCENERY: BuiltInImage[] = [
  ...
  unsplash('1501785888108-9e9e7f0e9c64', '星空银河'),
  unsplash('1469474968028-56623f02e42e', '绚丽极光'),
  unsplash('1472214103451-9374bd1c798e', '层峦叠嶂'),
  unsplash('1504198453319-5ce911bafcde', '金色麦田'),
...
const FOOD: BuiltInImage[] = [
  ...
  unsplash('1517093602195-b40b4e84d8e8', '奶茶'),
